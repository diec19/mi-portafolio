  ...
  <div className="md:grid md:grid-cols-2 md:gap-10 lg:gap-16 md:items-center">
    <div className="hidden md:block mb-24 md:mb-0 sm:px-6">
      <div className="relative">
        <img className="rounded-xl" src="https://img.freepik.com/vector-gratis/ilustracion-concepto-programacion_114360-1351.jpg?w=2000" alt="Image Description"/>
        ...
        <footer className="mt-6">
          <div className="flex items-center">
            ...
            <div className="ml-4 md:ml-0">
              <div className="text-base font-semibold text-gray-800 dark:text-gray-200">Nicole Grazioso</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Director Payments & Risk | Airbnb</div>
            </div>
          </div>
        </footer>
